...
bool ImGui_Impl_CreateDrawProgram()
{
...
{
  if (!ImGui_Impl_CreateDrawProgram() || !ImGui_Impl_CreateBuffers() || !ImGui_Impl_CreateFontsTexture())
  {
    return false;
  }
...
bool ImGui_Impl_Init(SDL_Window* window)
{
  ...
  io.RenderDrawListsFn = ImGui_Impl_RenderDrawLists; // Alternatively you can set this to NULL and call
...
void ImGui_Impl_NewFrame()
{
  ...
  io.MouseDown[0] = g_MousePressed[0] || (mouseMask & SDL_BUTTON(SDL_BUTTON_LEFT)) !=
                                           0; // If a mouse press event came, always pass it as "mouse held this frame",
